...
namespace Slin.Facturacion.BusinessEntities.InterfaceXMLCE
{
    ...
    {
        [XmlElement(ElementName = "DatoNroDoc")] //47
        public string DatoNroDoc { get; set; }
        [XmlElement(ElementName = "DatoCodTpoDoc")] //48
        public string DatoCodTpoDoc { get; set; }
        [XmlElement(ElementName = "DatoTpoDoc")] //49
        public string DatoTpoDoc { get; set; }
        [XmlElement(ElementName = "DatoNumDocRem")] //50
        public string DatoNumDocRem { get; set; }
        [XmlElement(ElementName = "DestNumDoc")] //51
        public string DestNumDoc { get; set; }
        [XmlElement(ElementName = "DestTpoDoc")] //52
        public string DestTpoDoc { get; set; }
        [XmlElement(ElementName = "DestRazSoc")] //53
        public string DestRazSoc { get; set; }
        [XmlElement(ElementName = "TrasMotivo")] //54
        public string TrasMotivo { get; set; }
        [XmlElement(ElementName = "TrasPeso")] //55
        public string TrasPeso { get; set; }
        [XmlElement(ElementName = "TrasUndMed")] //KG
        public string TrasUndMed { get; set; }
        [XmlElement(ElementName = "TrasModalidad")] //56
        public string TrasModalidad { get; set; }
        [XmlElement(ElementName = "TrasFecInicio")] //57
        public string TrasFecInicio { get; set; }
        [XmlElement(ElementName = "TranIDDoc")] // 59
        public string TranIDDoc { get; set; }
        [XmlElement(ElementName = "TranTpoDoc")] //60
        public string TranTpoDoc { get; set; }
        [XmlElement(ElementName = "TranRazSoc")] //61
        public string TranRazSoc { get; set; }
        [XmlElement(ElementName = "CondIDDoc")] //62
        public string CondIDDoc { get; set; }
        [XmlElement(ElementName = "CondTpoDoc")] //63
        public string CondTpoDoc { get; set; }
        [XmlElement(ElementName = "VehiConstancia")] //64
        public string VehiConstancia { get; set; }
        [XmlElement(ElementName = "VehiPlaca")] //65
        public string VehiPlaca { get; set; }
        [XmlElement(ElementName = "DirLlegUbigeo")] //67A
        public string DirLlegUbigeo { get; set; }
        [XmlElement(ElementName = "DirLlegDireccion")] //67B
        public string DirLlegDireccion { get; set; }
        [XmlElement(ElementName = "DirParUbigeo")] //68A
        public string DirParUbigeo { get; set; }
        [XmlElement(ElementName = "DirParDireccion")] //68B
