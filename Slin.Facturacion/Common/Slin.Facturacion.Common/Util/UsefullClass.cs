...
{
    public sealed class UsefullClass
    {
        private static readonly UsefullClass instance = new UsefullClass();
        static UsefullClass() { }
        private UsefullClass() { }
        public static UsefullClass Instance { get { return instance; } }
        ...
        //                        oFactura.TotalGravadoSinIGV = Convert.ToDecimal(xmlnodelist.Item(i).ChildNodes[1].InnerText, CultureInfo.CreateSpecificCulture("es-PE"));
        //                        break;
        //                    }
        ...
        //        else
        //        {
        //            if (inv.LegalMonetaryTotal.AllowanceTotalAmount == null)
        //            { oFactura.TotOtrosCargos = 0.00m; }
        //            else if (inv.LegalMonetaryTotal.AllowanceTotalAmount != null)
        //            {
        ...
        //                oFactura.TotOtrosCargos = Convert.ToDecimal(inv.LegalMonetaryTotal.AllowanceTotalAmount.Value, CultureInfo.CreateSpecificCulture("es-PE"));
        //            }
        //        }
        ...
        //                case "1001": { oFactura.TotalGravado = xmlnodelist.Item(i).ChildNodes[1].InnerText; break; }
        //                case "1002": { oFactura.TotalInafecto = xmlnodelist.Item(i).ChildNodes[1].InnerText; break; }
        //                case "1003": { oFactura.TotalExonerado = xmlnodelist.Item(i).ChildNodes[1].InnerText; break; }
        //                case "1004": { oFactura.TotalGratuito = xmlnodelist.Item(i).ChildNodes[1].InnerText; break; }
        //                case "1005": { oFactura.SubTotalVenta = xmlnodelist.Item(i).ChildNodes[1].InnerText; break; }
        ...
        //        else
        //        {
        //            if (nd.RequestedMonetaryTotal.AllowanceTotalAmount == null)
        //            { oFactura.TotOtrosCargos = 0.00m; }
        //            else if (nd.RequestedMonetaryTotal.AllowanceTotalAmount != null)
        //            {
        //                oFactura.TotOtrosCargos = Convert.ToDecimal(nd.RequestedMonetaryTotal.AllowanceTotalAmount.Value, CultureInfo.CreateSpecificCulture("es-PE"));
        //            }
        //        }
