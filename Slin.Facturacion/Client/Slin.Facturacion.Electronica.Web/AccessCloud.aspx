<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccessCloud.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.AccessCloud" %>
...
<body class="theme-6" style="background-image: url(Img/home/fondo.jpg); background-repeat: repeat-y; background-size: 100%;">
    ...
    <%--<div class="main-content" style="background-image: url(Img/home/fondo.jpg); background-size: cover; background-repeat: no-repeat; background-size: 100%;" >--%>

        <div class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                <a class="" href="AccessCloud.aspx"><span class="navbar-brand" style="font-family: Cambria; font-size: medium;">
                    <img runat="server" id="logoade" style="max-width: 250px" />
                    Administración de Documentos Electrónicos</span></a>
            </div>
        </div>
                ...
                <div class="panel-body" style="font-family: Cambria">
                    <form runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input runat="server" id="txtruccomp" class="form-control" placeholder="ruc" maxlength="11" required="required" autocomplete="off" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input runat="server" id="txtusuario" class="form-control" placeholder="usuario" maxlength="30" required="required" autocomplete="off" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input runat="server" id="txtpassword" class="form-control" type="password" maxlength="30" required="required" placeholder="*********" autocomplete="off" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <p class="pull-right" style=""><a href="#" target="blank" style="font-size: .75em; margin-top: .25em;">Design by Corp. Slin</a></p>
                            </div>
                            <div class="col-md-2">
                            </div>
                        </div>--%>
