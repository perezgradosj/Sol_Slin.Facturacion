...
namespace Slin.Facturacion.Electronica.Web
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        void Cargar()
        {
            ...
            //slinade.Src = "Img/logo/slinade.png";
        }
        ...
        void CapturarDatosUsuario()
        {
            try
            {
                ...
                //generar una lista desde el config
                //EntityRegex
        ...
        void ValidarDatos()
        {
            try
            {
                ...
                {
                    #region LOGIN WITH ACTIVE DIRECTORY
                    ...
                    else
                    {
                        ...
                        if (Acceso > 0)
                        {
                            ...
                            if (listentity.Contains(oUsuarioLogeado.Empresa.RUC))
                            {
                                ...
                                var IdSession = GetDataUserLogxInsert();
                            ...
                            {
                                var IdLog = GetDataUserLogxInsert();
        ...
        void GetKeyFromBD()
        {
            //var GetParameter = Request.QueryString["RUC"];
            //var sty = Request.Params["RUC"];
        ...
        private int GetDataUserLogxInsert()
        {
            ...
            try
            {
                ...
                ObjLogueo.Empresa.IdEmpresa = int.Parse(cboempresa.Value);
        ...
        public bool ValidarActiveDirectory()
        {
            ...
            using (DirectoryEntry _entry = new DirectoryEntry())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    //path = path + DateTime.Now.Year + "-" + string.Format("{0:00}", DateTime.Now.Month) + @"\logade\";

                    //if (!System.IO.Directory.Exists(path))
                        //System.IO.Directory.CreateDirectory(path);

                    //using (StreamWriter sw = new StreamWriter(path + "LDAP.log", true, Encoding.UTF8))
                    //{
                        ////sw.WriteLine("[" + DateTime.Now + "] Message: " + ex.Message + ", InnerException: " + ex.InnerException);
                    //}
                    //if (ex.Message == Constantes.MsjLoginWithActiveDirectoryOK) { return true; }
                    //else { return false; }
                    #region
        ...
        #endregion END LOGIN WITH ACTIVE DIRECTOTY
    }
}