...
(function (j, ra, p) {
    j.fn.dataTableSettings = []; var D = j.fn.dataTableSettings; j.fn.dataTableExt = {}; var n = j.fn.dataTableExt; n.sVersion = "1.7.6"; n.sErrMode = "alert"; n.iApiIndex = 0; n.oApi = {}; n.afnFiltering = []; n.aoFeatures = []; n.ofnSearch = {}; n.afnSortData = []; n.oStdClasses = {
        ...
        function m() {
            ...
            this.aanFeatures = []; this.oLanguage = { sProcessing: "Processing...", sLengthMenu: "Ver _MENU_ Entradas", sZeroRecords: "No se encontraron registros", sEmptyTable: "No hay datos disponibles en la tabla", sInfo: "Del _START_ al _END_ de _TOTAL_ Entradas", sInfoEmpty: "Del 0 a 0 de 0 Entradas", sInfoFiltered: "(filtrado de _MAX_ total Entradas)", sInfoPostFix: "", sSearch: "Buscar:", sUrl: "", oPaginate: { sFirst: "Primero", sPrevious: "Anterior", sNext: "Siguiente", sLast: "Ultimo" }, fnInfoCallback: null }; this.aoData = []; this.aiDisplay = []; this.aiDisplayMaster =
