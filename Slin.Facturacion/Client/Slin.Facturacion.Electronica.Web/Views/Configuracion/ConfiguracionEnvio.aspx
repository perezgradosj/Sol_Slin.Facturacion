<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="ConfiguracionEnvio.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Configuracion.ConfiguracionEnvio" %>
    ...
    <div class="content" style="background-repeat: no-repeat; background-image: url(../../Img/home/fondopantalla.jpg); background-size: cover">
        ...
        <div class="row">
            <div style="font-family: Cambria; font-size: medium">
                ...
                <a style="font-family: Cambria; height: 35px" href="ConfiguracionEnvio">/ Configurarción de Envió</a>
            </div>
        </div>

        <div class="modal-header">
            <label style="font-family: Cambria; font-size: 16px"><i class="glyphicon glyphicon-user padding-right-small"></i>Configuración para el Proceso de Envío</label>
        </div>
