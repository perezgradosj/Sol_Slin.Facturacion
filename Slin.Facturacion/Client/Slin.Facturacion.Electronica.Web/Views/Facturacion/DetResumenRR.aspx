<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetResumenRR.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.DetResumenRR" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="CSSTableGenerator2">
            <tr style="height: 30px; font-family: 'Lucida Sans Unicode'">
                <td colspan="10">
                    <%--<label style="font-size: larger">CORPORACIÓN SLIN SAC</label>--%>
        ...
        <table class="datagrid">
            ...
            <tr>
                ...
                <td>
                    <asp:GridView CssClass="grid sortable {disableSortCols: []}" runat="server" ID="GVListadoDetalleRR" AutoGenerateColumns="false" PageSize="20">
                        <Columns>
                        ...
                        <%--HeaderStyle-BackColor="#2c4a75" HeaderStyle-ForeColor="White"--%>
                    </asp:GridView>
                </td>
                <td></td>
            </tr>
