...
{
    public partial class GenerarRR : System.Web.UI.Page
    {
        ...
        private void Message()
        {
            try
            {
                string respuesta = (string)Session["MessageGenerateRRProcess"];
                if (respuesta.Length > Constantes.ValorCero)
                {
                    Session.Remove("MessageGenerateRRProcess");
        ...
        private void ChargerList()
        {
            ...
            oList_FacturaElect = ServiceFacturacionController.Instance.GetList_PendingsDocuments_RA(oUsuarioLogeado.Empresa.RUC, Constantes.Cod_RR);
        ...
        void GenerarResumen()
        {
            ...
            try
            {
                ...
                string ContentFile = "CABECERA-PRINCIPAL|RR|" + fech + "|" + oUsuarioLogeado.Empresa.RUC;
                string NameFile = oUsuarioLogeado.Empresa.RUC + "-RR-" + fecha.ToString("yyyyMMdd");
                ...
                Response.Write("<script language=javascript>alert('" + Constantes.msjOrdenGenerate_RR + "');</script>");
                ...
                //msje = ServiceFacturacionController.ProcesaR(fech, oUsuarioLogeado.Empresa.RUC, "RR");
        ...
        protected void btnGeneraSelected_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Session["MessageGenerateRRProcess"] = "Se Generaron " + list_Write.Count + " ordenes de resumen";
                    Response.Redirect("GenerarRR");
                }
                #endregion
            }
            catch (Exception ex) { }
