<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="GenerarRC.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.GenerarRC" %>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("table.grid").each(function () {
                    ...
                    if (grid.hasClass("sortable") && grid.find("tbody:first > tr").length > 1) {
                        grid.dataTable({
    ...
    <div class="content" style="background-repeat:no-repeat; background-image:url(../../Img/home/fondopantalla.jpg); background-size:cover">
        ...
        <div class="row">
            <div style="font-family: Cambria; font-size: medium">
                ...
                <a style="font-family: Cambria; height: 35px" href="GenerarRC">/ Generar Resumen de Boletas</a>
            </div>
        </div>
        ...
        <div class="modal-body" style="font-family: Cambria">
            ...
            <div class="row">
                <div class="col-md-5">
                    <a href="ConsultaRC" class="btn btn-primary" style="height:30px; font-family:Cambria; font-size:small"><i class="fa fa-arrow-left"></i> Cancelar</a>
