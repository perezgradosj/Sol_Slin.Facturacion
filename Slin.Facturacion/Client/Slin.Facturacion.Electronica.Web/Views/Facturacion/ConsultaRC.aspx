<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="ConsultaRC.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.ConsultaRC" %>
    ...
    <div class="content" style="background-repeat: no-repeat; background-image: url(../../Img/home/fondopantalla.jpg); background-size: cover">
        ...
        <div class="row">
            <div style="font-family: Cambria; font-size: medium">
                ...
                <a style="font-family: Cambria; height: 35px" href="ConsultaRC">/ Resumen de Boletas RC</a>
            </div>
        </div>
        ...
        <div class="modal-body" style="font-family: Cambria;">
            ...
            <div class="row">
                <div class="col-lg-2" style="width: 110px">
                    <label style="width: 80px; height: 27px; padding-top: 8px">Estado:</label>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <a runat="server" id="btnNuevo" style="height: 30px; font-size: small; font-family: Cambria" href="GenerarRC.aspx" class="btn btn-primary" aria-hidden="true" visible="false"><i class="fa fa-plus"> Nuevo</i></a>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <asp:GridView runat="server" ID="GVListadoRC" CssClass="grid sortable {disableSortCols: [0]}" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:BoundField  HeaderStyle-ForeColor="White" ItemStyle-Font-Size="Smaller" ItemStyle-HorizontalAlign="Center" DataField="MensajeEnvio" HeaderText="Mensaje Envio" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Left" />
