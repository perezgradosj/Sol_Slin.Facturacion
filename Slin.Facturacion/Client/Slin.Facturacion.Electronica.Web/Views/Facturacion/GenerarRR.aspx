<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="GenerarRR.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.GenerarRR" %>
    ...
    <div class="content" style="background-repeat:no-repeat; background-image:url(../../Img/home/fondopantalla.jpg); background-size:cover">
        ...
        <div class="row">
            <div style="font-family: Cambria; font-size: medium">
                ...
                <a style="font-family: Cambria; height: 35px" href="GenerarRR">/ Generar Resumen Reversiones</a>
            </div>
        </div>

        <div class="modal-header">
            <label style="font-family: Cambria; font-size: 17px"><i class="fa fa-apple"></i> Datos</label>
        </div>
        ...
        <div class="modal-body" style="font-family: Cambria">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <asp:Button runat="server" ID="btnGenerar" Height="30px" Font-Size="Small" Text="Generar Resumen" CssClass="btn btn-primary" Font-Names="Cambria" OnClick="btnGenerar_Click" />
                </div>
            ...
            <br />
            <hr />
            <b style="font-size: small">Lista de Documentos pendientes de envio</b>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <asp:GridView runat="server" ID="GVListPendingDocument" CssClass="grid sortable {disableSortCols: []}" AutoGenerateColumns="false">
            ...
            <div class="row">
                <div class="col-md-2">
                    <label style="min-width:9px"></label>
            ...
            <div class="row">
                <div class="col-md-5">
                    <a href="ConsultaRR" class="btn btn-primary" style="height:30px; font-family:Cambria; font-size:small"><i class="fa fa-arrow-left"></i> Cancelar</a>
