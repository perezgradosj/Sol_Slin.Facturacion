<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="ActualizarEstado.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.ActualizarEstado" %>
    ...
    <div class="content" style="background-repeat: no-repeat; background-image: url(../../Img/home/fondopantalla.jpg); background-size: cover">
        ...
        <div class="row">
            <div style="font-family: Cambria; font-size: medium">
                ...
                <a style="font-family: Cambria; height: 35px" href="AnularDocumento">/ Actualizar Estado</a>
            </div>
        </div>

        <div class="modal-header">
            <label style="font-family: Cambria; font-size: 16px"><i class="fa fa-book"></i> Ingrese datos del Documento</label>
        </div>
                ...
                <div class="modal-body" style="font-family: Cambria;">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <select runat="server" name="cbotipodocumento" class="form-control">
