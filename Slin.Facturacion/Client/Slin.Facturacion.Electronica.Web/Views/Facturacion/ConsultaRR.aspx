<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="ConsultaRR.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.ConsultaRR" %>
    ...
    <div class="content" style="background-repeat:no-repeat; background-image:url(../../Img/home/fondopantalla.jpg); background-size:cover">
        ...
        <div class="row">
            <div style="font-family: Cambria; font-size: medium">
                ...
                <a style="font-family: Cambria; height: 35px" href="ConsultaRA">/ Resumen de Anulados RR</a>
            </div>
        </div>
        ...
        <div class="modal-body" style="font-family: Cambria">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <a runat="server" id="btnNuevoRR" style="height: 30px; font-size: small; font-family: Cambria" href="GenerarRR.aspx" class="btn btn-primary" aria-hidden="true" visible="false"><i class="fa fa-plus"> Nuevo</i></a>
            ...
            <div class="row">
                <div class="table-responsive">
                    ...
                    <asp:GridView runat="server" ID="GVListadoRR" CssClass="grid sortable {disableSortCols: [0]}" AutoGenerateColumns="false">
                        <Columns>
