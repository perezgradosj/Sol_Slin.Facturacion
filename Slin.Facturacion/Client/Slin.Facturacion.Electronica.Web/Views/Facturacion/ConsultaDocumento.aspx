<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="ConsultaDocumento.aspx.cs" Inherits="Slin.Facturacion.Electronica.Web.Views.Facturacion.ConsultaDocumento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <header>
        ...
        <script type="text/javascript">
            ...
            //        $.ajax({
            //            type: 'POST',
            //            url: 'ConsultaDocumento.aspx/buscar',
            //            data: JSON.stringify(),
            ...
            //                $('#lbl1').text('Hola');
            //                //confirm();
            //                //$(document.getElementById('#lbl1').text('Hola Causa'));
            //                //alert("OK");
            //            },
            //            error: function (req, stat, err) {
            //                var error = eval("(" + req.responseText + ")");
            //                //$('#lbl1').text(error.Message);
            //                //alert("SI");
            //            }
            //        });
            //    });
            ...
            //                var num = resultado.d;
            //                $('#lbl1').text('Numero encontrado: ' + num);
    ...
    <div lang="es-pe" class="content" style="background-repeat: no-repeat; background-image: url(../../Img/home/fondopantalla.jpg); background-size: cover">
        ...
        <div class="row" style="border-color: none">
            <div style="font-family: Cambria; font-size: medium;">
                ...
                <a style="font-family: Cambria; height: 35px" href="ConsultaDocumento">/ Consulta de Documentos CE</a>
            </div>
        </div>
            ...
            <div class="tab-pane active" id="consulta">
                <div class="col-md-12" style="font-family: Cambria;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a runat="server" onserverclick="btnBuscar_Click" style="height: 30px; font-size: small; font-family: Cambria" class="btn btn-primary" id="btnBuscar" visible="false"><i class="fa fa-search"></i> Buscar</a>
                        </div>
                        <div class="col-md-1">
                            <label></label>
                        </div>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            ...
                            <asp:GridView runat="server" ID="GridView1" CssClass="grid sortable {disableSortCols: []}" AutoGenerateColumns="false"
                                ShowHeaderWhenEmpty="false" OnRowDataBound="GridView1_RowDataBound">
                                <Columns>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Print" HeaderStyle-Font-Size="Smaller" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkSelImp" Height="15px" Width="12px" ToolTip="Select to Print" OnClick="return Validar();" AutoPostBack="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    ...
                                    <asp:TemplateField HeaderText="Xml" HeaderStyle-Font-Size="Smaller" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton target="_blank" runat="server" ID="btnImgXML" ImageUrl="~/Img/xml.jpg" Height="15px" Width="12px" OnClick="btnImgXML_Click" ToolTip="Descargar Xml Doc." />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="CDR" HeaderStyle-Font-Size="Smaller" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" target="_blank" Visible="false" ID="btnImgCDR" ImageUrl="~/Img/xml.jpg" Height="15px" Width="12px" OnClick="btnImgCDR_Click" ToolTip="Descargar CDR Doc." />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField HeaderStyle-ForeColor="White" ItemStyle-Font-Size="Smaller" ItemStyle-HorizontalAlign="Center" DataField="FechaEmision2"  DataFormatString="{0:d}" HeaderText="Fecha Emisión" HeaderStyle-Wrap="false" />
